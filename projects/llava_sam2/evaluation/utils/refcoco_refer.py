...
class REFER:
    def __init__(self, data_root, dataset="refcoco", splitBy="unc"):
        ...
        if dataset in ["refcoco", "refcoco+", "refcocog"]:
            ...
            self.IMAGE_DIR = osp.join(data_root, "rrsisd/images/")
        elif dataset == "refsegrs":
            self.IMAGE_DIR = osp.join(data_root, "refsegrs/images/")
        elif dataset == "risbench":
            self.IMAGE_DIR = osp.join(data_root, "risbench/images/")
        elif dataset == "sarnew":
            self.IMAGE_DIR = osp.join(data_root, "sarnew/images/")
        else:
